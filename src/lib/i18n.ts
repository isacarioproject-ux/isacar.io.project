...
const translations: Translations = {
  ...
  'pages.elements.elementAdded': { 'pt-BR': '✓ Elemento adicionado', 'en': '✓ Element added', 'es': '✓ Elemento añadido' },
  ...
  'pages.export.stats': { 'pt-BR': 'Estatísticas', 'en': 'Statistics', 'es': 'Estadísticas' },
  'pages.export.viewStats': { 'pt-BR': 'Ver Estatísticas', 'en': 'View Statistics', 'es': 'Ver Estadísticas' },
  'pages.export.docStats': { 'pt-BR': 'Estatísticas do Documento', 'en': 'Document Statistics', 'es': 'Estadísticas del Documento' },
  ...
  'pages.export.copied': { 'pt-BR': '✓ Copiado para área de transferência', 'en': '✓ Copied to clipboard', 'es': '✓ Copiado al portapapeles' },
  ...
  'pages.export.emptyPage': { 'pt-BR': 'Página vazia', 'en': 'Empty page', 'es': 'Página vacía' },
  ...
  'pages.export.pdfExported': { 'pt-BR': '✓ PDF exportado', 'en': '✓ PDF exported', 'es': '✓ PDF exportado' },
  'pages.export.markdownExported': { 'pt-BR': '✓ Markdown exportado', 'en': '✓ Markdown exported', 'es': '✓ Markdown exportado' },
  'pages.export.htmlExported': { 'pt-BR': '✓ HTML exportado', 'en': '✓ HTML exported', 'es': '✓ HTML exportado' },
  'pages.export.textExported': { 'pt-BR': '✓ Texto exportado', 'en': '✓ Text exported', 'es': '✓ Texto exportado' },
  ...
  'pages.confirmDelete': { 'pt-BR': 'Excluir esta página?', 'en': 'Delete this page?', 'es': '¿Eliminar esta página?' },
  ...
  'pages.templates.description': { 'pt-BR': 'Comece com um template pronto e personalize conforme necessário', 'en': 'Start with a ready-made template and customize as needed', 'es': 'Comienza con una plantilla lista y personaliza según sea necesario' },
  ...
  'pages.templates.meetingnotesDesc': { 'pt-BR': 'Template estruturado para documentar reuniões', 'en': 'Structured template for documenting meetings', 'es': 'Plantilla estructurada para documentar reuniones' },
  ...
  'pages.templates.content.meeting10am': { 'pt-BR': 'Reunião às 10h', 'en': 'Meeting at 10am', 'es': 'Reunión a las 10h' },
  ...
  'pages.templates.placeholder.source': { 'pt-BR': 'Livro/Curso/Artigo', 'en': 'Book/Course/Article', 'es': 'Libro/Curso/Artículo' },
  ...
  'pages.comments.added': { 'pt-BR': '✓ Comentário adicionado', 'en': '✓ Comment added', 'es': '✓ Comentario añadido' },
  'pages.comments.deleted': { 'pt-BR': '✓ Comentário excluído', 'en': '✓ Comment deleted', 'es': '✓ Comentario eliminado' },
  'pages.comments.resolved': { 'pt-BR': '✓ Resolvido', 'en': '✓ Resolved', 'es': '✓ Resuelto' },
  ...
  'pages.shortcuts.comments': { 'pt-BR': 'Ctrl+/', 'en': 'Ctrl+/', 'es': 'Ctrl+/' },
