...
const translations: Translations = {
  ...
  'projects.tabs.newProject': { 'pt-BR': 'Novo Projeto', 'en': 'New Project', 'es': 'Nuevo Proyecto' },
  'projects.tabs.myProjects': { 'pt-BR': 'Meus Projetos', 'en': 'My Projects', 'es': 'Mis Proyectos' },
  'projects.tabs.documents': { 'pt-BR': 'Gestão de Documentos', 'en': 'Document Management', 'es': 'Gestión de Documentos' },
  'projects.new.title': { 'pt-BR': 'Nenhum Projeto Ainda', 'en': 'No Projects Yet', 'es': 'Aún No Hay Proyectos' },
  'projects.new.description': { 'pt-BR': 'Você ainda não criou nenhum projeto. Comece criando seu primeiro projeto.', 'en': "You haven't created any projects yet. Get started by creating your first project.", 'es': 'Aún no has creado ningún proyecto. Comienza creando tu primer proyecto.' },
  'projects.new.import': { 'pt-BR': 'Importar Projeto', 'en': 'Import Project', 'es': 'Importar Proyecto' },
  'projects.new.learnMore': { 'pt-BR': 'Saiba Mais', 'en': 'Learn More', 'es': 'Más Información' },
  'projects.documents.title': { 'pt-BR': 'Documentos do Projeto', 'en': 'Project Documents', 'es': 'Documentos del Proyecto' },
  'projects.documents.description': { 'pt-BR': 'Gerencie todos os documentos relacionados aos seus projetos', 'en': 'Manage all documents related to your projects', 'es': 'Gestiona todos los documentos relacionados con tus proyectos' },
  'projects.documents.selectProject': { 'pt-BR': 'Selecione um projeto', 'en': 'Select a project', 'es': 'Selecciona un proyecto' },
  'projects.documents.uploadDocs': { 'pt-BR': 'Enviar Documentos', 'en': 'Upload Documents', 'es': 'Subir Documentos' },
  ...
  'team.inviteSent': { 'pt-BR': 'Convite enviado com sucesso!', 'en': 'Invite sent successfully!', 'es': '¡Invitación enviada con éxito!' },
