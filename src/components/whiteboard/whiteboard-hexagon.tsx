...
export const WhiteboardHexagon = ({ item, onUpdate, onDelete }: Props) => {
      ...
      <div ref={nodeRef} className="absolute cursor-move" style={{ width, height }}>
        ...
        >
          <polygon
            ...
            className={cn('transition-all hover:scale-105', shapeColors[(item.shapeColor as ShapeColorKey) || 'green'])}
            strokeWidth={2}
